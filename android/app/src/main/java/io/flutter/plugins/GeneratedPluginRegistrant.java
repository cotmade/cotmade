...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new video.api.flutter.uploader.ApiVideoUploaderPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin video_uploader, video.api.flutter.uploader.ApiVideoUploaderPlugin", e);
    }
    try {
