...
import 'package:cotmade/view/conversation_screen.dart';
import 'package:cotmade/view/widgets/conversation_list_tile_ui.dart';
          ...
          if (dataSnapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  currentConversation
                      .getConversationInfoFromFirestore(snapshot);
