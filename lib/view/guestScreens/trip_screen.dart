                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                posting['name'] ?? 'No Title',
                                style: TextStyle(
                                    fontSize: 18, fontWeight: FontWeight.bold),
                              ),
                              SizedBox(height: 8),
                              Text(posting['type'] ?? 'No type'),
                              SizedBox(height: 8),
                              Text(posting['description'] ?? 'No Description'),
                              SizedBox(height: 8),
                              Text(posting['address'] ?? 'No Address'),
                              SizedBox(height: 8),
                              Text(posting['city'] ?? 'city undefined'),
                              SizedBox(height: 8),
                              Text(posting['country'] ?? 'undefined'),
                              //   SizedBox(height: 8),
                              //   Text('NGN: $payments'),
                              SizedBox(height: 8),
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  // Pass postingID to the ViewPostingScreen
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
