...
class _withdrawState extends State<withdraw> {
  ...
  Future<void> _saveWithdrawalDetails(double withdrawalAmount) async {
    try {
      ...
      if (user != null) {
        ...
        // Send email
        await sendWelcomeEmail(AppConstants.currentUser.email.toString(),
            AppConstants.currentUser.getFullNameOfUser(), withdrawalAmount);
  ...
  Future<void> sendWelcomeEmail(
      String email, String fname, double withdrawalAmount) async {
    final url =
