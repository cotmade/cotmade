                        ...
                        Center(
                          child: Column(
                            ...
                            children: [
                              MaterialButton(
                                onPressed: () {
                                  // Navigate to BoostPropertyPage and pass the postingId
                              ...
                              const SizedBox(
                                  height:
                                      10), // Add spacing between button and text
                              const Text(
                                "* you can boost the visibility of your listing here",
                                style: TextStyle(
