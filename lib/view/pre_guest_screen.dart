...
class PreGuestScreen extends StatefulWidget {
  const PreGuestScreen({super.key});

  @override
  State<PreGuestScreen> createState() => _PreGuestScreenState();
}

class _PreGuestScreenState extends State<PreGuestScreen> {
  @override
  void initState() {
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  "Switching to Guest Mode", //enter text on splash screen
